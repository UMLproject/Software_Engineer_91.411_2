...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2015 at 05:28 AM
...
--
ALTER TABLE `admins`
 ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `Username` (`Username`), ADD UNIQUE KEY `Username_2` (`Username`), ADD UNIQUE KEY `AccessCode` (`AccessCode`), ADD UNIQUE KEY `Email` (`Email`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `Username` (`Username`), ADD UNIQUE KEY `Username_2` (`Username`), ADD UNIQUE KEY `Email` (`Email`);
