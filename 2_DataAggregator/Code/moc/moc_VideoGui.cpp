...
static const char qt_meta_stringdata_VideoGui[] = {
    "VideoGui\0"
};
...
const QMetaObjectExtraData VideoGui::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoGui,
      qt_meta_data_VideoGui, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoGui::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoGui))
